...
from app.routes import market, analytics, portfolio, auth, notifications, backtest, alerts, trade, rsi_scanner, admin, strategy, custom_strategy
...
app.include_router(custom_strategy.router)
